module module/red-network

go 1.24.3

require (
	github.com/aws/aws-sdk-go-v2 v1.36.5 // indirect; For your custom AWS operations
	github.com/aws/aws-sdk-go-v2/config v1.29.17 // indirect; For v2 config
	github.com/aws/aws-sdk-go-v2/service/s3 v1.81.0 // indirect; For v2 S3 operations
